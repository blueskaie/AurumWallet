    ...
    { token 
      ? <Fragment>
          ...
          { (tokenLogos[token.code.toUpperCase()] && (token.code.toUpperCase() === 'AUR'))?
            <img src="images/AurumLogo-whitecircule.svg" alt={token.code} width={20} /> : 
            (tokenLogos[token.code.toUpperCase()]
              ? <img src={tokenLogos[token.code.toUpperCase()]} alt={token.code} width={20} style={{borderRadius: '50%'}} />
